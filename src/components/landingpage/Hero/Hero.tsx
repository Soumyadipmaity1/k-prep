...
const Hero: FC = () => {
  return (
    <section className="flex flex-col md:flex-row gap-28 items-center justify-between  px-16 bg-white">
      <div className=" mb-6 md:mb-0 mt-10">
        <h1 className="text-7xl font-bold mb-4">READ, LEARN,</h1>
        <h1 className="text-7xl font-bold mb-4"> ACE!</h1>

        <p className="text-gray-600 mb-6 mt-8 font-sans">
      ...
      <div className="relative w-full  flex flex-col items-center">
        ...
        <div className="absolute top-60 cursor-pointer hover:bg-white shadow-lg left-0 flex items-center space-x-2 bg-[#e4e1e1bd] p-2 rounded-lg border-2 border-purple-400 ">
        ...
        <div className="absolute bottom-4 cursor-pointer hover:bg-white shadow-lg left-4 flex items-center space-x-2 bg-[#e4e1e1bd] p-2 rounded-lg border-2 border-purple-400 ">
          <div className='text-2xl text-purple-500 pr-2'>
            <FaFileAlt />
          </div>
          <div>
