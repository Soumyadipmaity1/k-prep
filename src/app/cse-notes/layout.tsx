      ...
      <div className="flex justify-between sm:hidden   h-screen mt-6 rounded-xl">
        <aside className='bg-sidebar text-white rounded-xl transition-all duration-300 px-2'>
          <div className="flex flex-col justify-center">
            <div>
              {/* <div className="flex cursor-pointer text-center items-center justify-between mt-10">
                <button title="toggle" onClick={toggleSidebar} className="focus:outline-none">
                  <FaBars size={16} />
                </button>
              </div> */}
              <nav className="mt-8 flex-col justify-center">
                ...
                <div
                  className={`flex cursor-pointer my-4 py-0.5 items-center ${getNavItemClass('/cse-notes/2nd-year')}`}
                  onClick={() => openModal(<SecondYearModal isOpen={true} onClose={closeModal} title="Second Year" yearPath="/cse-notes/2nd-year" />)}
                >
                  <MdLooksTwo size={20} />
                  {isOpen && <span className="text-xl">2nd Year</span>}
                ...
                <div
                  className={`flex cursor-pointer my-4 py-0.5 items-center space-x-1 ${getNavItemClass('/cse-notes/3rd-year')}`}
                  onClick={() => openModal(<ThirdYearModal isOpen={true} onClose={closeModal} title="Third Year" yearPath="/cse-notes/3rd-year" />)}
                >
                  <MdLooks3 size={20} />
                  {isOpen && <span className="text-xl">3rd Year</span>}
                ...
                <div
                  className={`flex cursor-pointer my-4 py-0.5 items-center ${getNavItemClass('/cse-notes/additional-notes')}`}
                  onClick={() => router.push('/cse-notes/additional-notes')}
                >
                  <FiEdit size={20} />
                  {isOpen && <span className="text-xl">Additional Notes</span>}
            ...
            <div className="cursor-pointer flex hover:border-l-2 border-white items-center bottom-0">
              <Link href="https://google.com" target="_blank">
                <button title="feedback" className="focus:outline-none flex">
